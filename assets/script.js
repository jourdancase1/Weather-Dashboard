...
function populateCityWeather(city, citySearchList) {
  ...
  var queryURL =
    "https://api.openweathermap.org/data/2.5/weather?&units=imperial&appid=c9a9ed03a355403f4cb9a36e931c0b4a&q=" +
    city;

  var queryURL2 =
    "https://api.openweathermap.org/data/2.5/forecast?&units=imperial&appid=c9a9ed03a355403f4cb9a36e931c0b4a&q=" +
    city;
  ...
  $.ajax({
    ...
    .then(function(weather) {
      ...
      var queryURL3 =
        "https://api.openweathermap.org/data/2.5/uvi/forecast?&units=imperial&appid=c9a9ed03a355403f4cb9a36e931c0b4a&q=" +
        "&lat=" +
        latitude +
        "&lon=" +
        longitude;
